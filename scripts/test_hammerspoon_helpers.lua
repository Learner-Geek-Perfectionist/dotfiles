...
assertEqual(persistedAtomState["default-service-tier"], "fast", "Desktop UI speed is pinned to the fast menu value")
...
assertTrue(codexConfig:find('model = "gpt-5.5"', 1, true), "Codex config sync pins the default model")
assertTrue(codexConfig:find('model_context_window = 1050000', 1, true), "Codex config sync pins the model context window")
assertTrue(codexConfig:find('model_auto_compact_token_limit = 900000', 1, true), "Codex config sync pins auto compact limit")
assertTrue(codexConfig:find('model_reasoning_effort = "xhigh"', 1, true), "Codex config sync pins reasoning effort")
assertTrue(codexConfig:find('approval_policy = "never"', 1, true), "Codex config sync pins approval policy")
assertTrue(codexConfig:find('sandbox_mode = "danger-full-access"', 1, true), "Codex config sync pins sandbox mode")
...
assertTrue(codexConfig:find('default-service-tier = "fast"', 1, true), "Codex config sync pins the Desktop fast UI value")
